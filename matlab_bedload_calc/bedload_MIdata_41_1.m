...
% average ripple migration rate


Sv_subset_new=Sv_subset' ;
ifig=1; 
if(ifig==1)
figure(1)
...
% 
 if(rip_MI(t)>0.45)
    bedload_41_1(t)=0.0;
    rip_mig_rate_41_1(t)=0.0;
 else
     rip_note_MI(t)=rip_MI(t); 
    bedload_41_1(t) = (1-0.4)*0.5*0.16*rip_MI(t)*rip_mig_rate(t)/3600 ; %*totalMigrate[i]
    rip_mig_rate_41_1(t)=rip_mig_rate(t) ;  
 end  
end 
  save('bedload_41_1.mat','rip_mig_rate_41_1', 'bedload_41_1');
