...
% 
 ...
 if(rip_MI(t)>0.45)
    bedload_3(t)=0.0;
    rip_mig_rate_3(t)=0.0;
 else
    bedload_31(t) = (1-0.4)*0.5*0.16*rip_MI(t)*rip_mig_rate(t)/3600 ; %*totalMigrate[i]
    rip_mig_rate_31(t)=rip_mig_rate(t) ;  
 end
end 
  save('bedload_31.mat','rip_mig_rate_31', 'bedload_31'); 