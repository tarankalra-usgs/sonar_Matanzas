...
%load('C:\Users\tkalra\Desktop\sonardata_tsk\MI_early_matlab\matfiles_MI_ripplemigrate/migrate11_2.mat') ; 
...
% 
 ...
 if(rip_MI(t)>0.45)
    bedload_11_2(t)=0.0;
    rip_mig_rate_11_2(t)=0.0;
 else
    bedload_11_2(t) = (1-0.4)*0.5*0.16*rip_MI(t)*rip_mig_rate(t)/3600 ; %*totalMigrate[i]
    rip_mig_rate_11_2(t)=rip_mig_rate(t) ; 
 end
end 
 save('bedload_11_2.mat','rip_mig_rate_11_2', 'bedload_11_2'); 