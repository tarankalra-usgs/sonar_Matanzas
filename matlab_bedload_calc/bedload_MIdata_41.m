...
load('C:\Users\tkalra\Desktop\sonardata_tsk\taran_exp2\migrate41.mat');
...
% 
    bedload_41(t) = (1-0.4)*0.5*0.16*rip_MI(t)*rip_mig_rate(t)/3600 ; %*totalMigrate[i]
    rip_mig_rate_41(t)=rip_mig_rate(t) ;  
end 
  save('bedload_41.mat','rip_mig_rate_41', 'bedload_41'); 