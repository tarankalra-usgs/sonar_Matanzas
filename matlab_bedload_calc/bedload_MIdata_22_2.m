...
% 
 ...
 if(rip_MI(t)>0.45)
    bedload_22_2(t)=0.0;
    rip_mig_rate_22_2(t)=0.0;
 else
    bedload_22_2(t) = (1-0.4)*0.5*0.16*rip_MI(t)*rip_mig_rate(t)/3600 ; %*totalMigrate[i]
    rip_mig_rate_22_2(t)=rip_mig_rate(t) ;
 end 
end 
  save('bedload_22_2.mat','rip_mig_rate_22_2', 'bedload_22_2'); 